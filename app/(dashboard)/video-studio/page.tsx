...
export default async function VideoStudioPage({
  ...
  return (
    <div className="mx-auto max-w-5xl">
      <h1 className="font-display text-2xl text-ink">Video Studio</h1>
      <p className="mt-1 text-sm text-muted">
        The Video Agent writes a scene-by-scene script an editor can shoot
        and cut from.
      </p>
      <div className="mt-6">
        <VideoStudio brands={allBrands} contentItems={allContent} defaultContentId={contentId} />
      </div>
    </div>
  );
}
